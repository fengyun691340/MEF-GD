...
class VitonHDDataset(data.Dataset):
    def __init__(
        ...
        if phase == 'train':
            ...
            filename = os.path.join(dataroot, f"{phase}_pairs4.txt")
    ...
    def __getitem__(self, index):
        ...
        if "im_sketch" in self.outputlist:
            ...
            sketchpath="/home/sd/Harddisk/zj/imageprocess/blur2"
            sketchpath="/home/sd/Harddisk/zj/imageprocess/imagesketch"
            # sketchname=c_name.replace(".jpg", "_gaussian_lvl3.jpg")
            sketchname=c_name.replace(".jpg", "_14.png")
            if self.order == 'unpaired':
                ...
                im_sketch = Image.open(os.path.join(sketchpath, sketchname)).convert('L')
                #im_sketch = Image.open(os.path.join(sketchpath,  im_name.replace(".jpg", ".png"))).convert('L')
